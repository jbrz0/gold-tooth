...
export default {
  ...
  // Button
  btnFontFamily: (Platform.OS === 'ios') ? 'AvenirNext-Regular' : 'Roboto_medium',
  ...
  // Header
  iosToolbarBtnColor: '#F3F3F3',
  toolbarDefaultBg: (Platform.OS === 'ios') ? 'rgba(243,243,243, 0.04)' : '#4179F7',
  toolbarHeight: (Platform.OS === 'ios') ? 74 : 56,
